...
class ElFarolBar:
    def __init__(self, seed, num_agents, num_contagious_agents, capacity, threshold, contagious_threshold, contagious_duration, people_memory_weight: float = 0.7, contagious_thresholdNotPresent: float = 1, Use_SIR: bool = False, SIR_AgentsRecoveryTime: int = 0, debugCSV: bool = False): 
